...
class Collection(Base):
    ...
    songs = relationship(
        "Song", secondary=collection_songs, back_populates="collections"
    )
...
class Song(Base):
    ...
    composers = relationship(
        "Composer", secondary=composer_songs, back_populates="songs"
    )

    collections = relationship(
        "Collection", secondary=collection_songs, back_populates="songs"
    )
